                    ...
                    <div class="row">
						<div class="col-md-6">
							...
							<div class='form-group @if($errors->has('kode_pos')) has-error @endif'>
								...
								<input type='text' placeholder='Kode Pos' class='form-control limited' id='kode_pos' name='kode_pos' maxlength='100' value='@if(count($errors) > 0){{old('kode_pos')}}@endif'
								required>
							...
							<div class='form-group @if($errors->has('nip_kades')) has-error @endif'>
								<label class='control-label'>Kode Desa</label>
								<input type='text' placeholder='Kode Desa' class='form-control limited' id='nip_kades' name='nip_kades' maxlength='100' value='@if(count($errors) > 0){{old('nip_kades')}}@endif'
								required>
							...
							<div class='form-group @if($errors->has('telepon')) has-error @endif'>
								...
								<input type='text' placeholder='Telepon Kantor' class='form-control limited' id='telepon' name='telepon' maxlength='100' value='@if(count($errors) > 0){{old('telepon')}}@endif'
								required>
