		...
		<div class="col-sm-12">	
			...
			<div class="clear panel panel-default">						
				<div class="panel-body">
					...
					<div class="row">
						<form action="{{url('data-rekapitulasi-penduduk-akhir-bulan')}}" method="get">
							{{ csrf_field() }}
							<div class="col-md-2">
							...
							<div class="col-md-2">
								<div class="form-group">
									...
									<select name="tahun" id="tahun" class="form-control search-select">
										<option value="">Semua</option>
										<option value="2018" @if($tahun == 2018)selected @else @endif>2018</option>
										<option value="2019" @if($tahun == 2019)selected @else @endif>2019</option>
									</select>
								</div>
							</div>
							<div class="col-md-3">
						...
						<tbody>
							...
							@foreach ($rekappenduduk as $p)
								<tr>
									...
									<td>@php echo AwalKK($p->dusun,$awalbulan); @endphp</td>
									<td></td>
									<td></td>
									...
									<td>@php echo AkhirKK($p->dusun,$akhirbulan); @endphp</td>
									<td></td>
									<td></td>
