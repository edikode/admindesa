						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class='form-group @if($errors->has('nama')) has-error @endif'>
									...
									<input type='text' placeholder='Jenis/Nama Hasil Pembangunan' class='form-control limited' id='nama' name='nama' maxlength='100' value='@if(count($errors) > 0){{old('nama')}}@else{{$pd->nama}}@endif'
									required>
								...
								<div class='form-group @if($errors->has('biaya')) has-error @endif'>
									...
									<input type='number' placeholder='Biaya' class='form-control limited' id='biaya' name='biaya' maxlength='10' value='@if(count($errors) > 0){{old('biaya')}}@else{{$pd->biaya}}@endif' required>
