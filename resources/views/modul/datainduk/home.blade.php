							...
							<div class="col-md-4">
								<div class='form-group @if($errors->has('tgl_lahir')) has-error @endif'>
									...
									<div class="input-group">
										<input name="tgl_lahir" placeholder="Tanggal Lahir" type="text" data-date-format="dd-mm-yyyy" data-date-viewmode="years" class="form-control date-picker" value="@if(count($errors) > 0){{old('tgl_lahir')}}@endif" required>
						...
						<div class="row">
							<div class="col-md-4">
								<div class='form-group @if($errors->has('rtrw')) has-error @endif'>
									...
									<input type='text' placeholder='RT/RW' class='form-control limited' id='rtrw' name='rtrw' maxlength='100' value='@if(count($errors) > 0){{old('rtrw')}}@endif'
									required>
							...
							<div class="col-md-4">
								<div class='form-group @if($errors->has('dusun')) has-error @endif'>
									...
									<input type='text' placeholder='Dusun' class='form-control limited' id='dusun' name='dusun' maxlength='100' value='@if(count($errors) > 0){{old('dusun')}}@endif'
									required>
							...
							<div class="col-md-4">
								<div class='form-group @if($errors->has('desa')) has-error @endif'>
									...
									<input type='text' placeholder='Desa' class='form-control limited' id='desa' name='desa' maxlength='100' value='@if(count($errors) > 0){{old('desa')}}@endif'
									required>
							...
							<div class="col-md-4">
								<div class='form-group @if($errors->has('kecamatan')) has-error @endif'>
									...
									<input type='text' placeholder='Kecamatan' class='form-control limited' id='kecamatan' name='kecamatan' maxlength='100' value='@if(count($errors) > 0){{old('kecamatan')}}@endif'
									required>
							...
							<div class="col-md-4">
								<div class='form-group @if($errors->has('kabupaten')) has-error @endif'>
									...
									<input type='text' placeholder='Kabupaten' class='form-control limited' id='kabupaten' name='kabupaten' maxlength='100' value='@if(count($errors) > 0){{old('kabupaten')}}@endif'
									required>
							...
							<div class="col-md-4">
								<div class='form-group @if($errors->has('kodepos')) has-error @endif'>
									...
									<input type='text' placeholder='Kode Pos' class='form-control limited' id='kodepos' name='kodepos' maxlength='100' value='@if(count($errors) > 0){{old('kodepos')}}@endif'
									required>
