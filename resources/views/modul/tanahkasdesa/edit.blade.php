						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class='form-group @if($errors->has('asal')) has-error @endif'>
									...
									<input type='text' placeholder='Asal Tanah Kas Desa' class='form-control limited' id='asal' name='asal' maxlength='100' value='@if(count($errors) > 0){{old('asal')}}@else{{$kd->asal}}@endif'
									required>
								...
								<div class='form-group @if($errors->has('nomor_sertifikat')) has-error @endif'>
									...
									<input type='text' placeholder='nomor sertifikat, atau buku Letter C, atau Persil' class='form-control limited' id='nomor_sertifikat' name='nomor_sertifikat' maxlength='100' value='@if(count($errors) > 0){{old('nomor_sertifikat')}}@else{{$kd->nomor_sertifikat}}@endif'
									required>
								...
								<div class='form-group @if($errors->has('luas')) has-error @endif'>
									...
									<input type='text' placeholder='luas tanah kas Desa dalam meter persegi (M2)' class='form-control limited' id='luas' name='luas' maxlength='100' value='@if(count($errors) > 0){{old('luas')}}@else{{$kd->luas}}@endif'
									required>
								...
								<div class='form-group @if($errors->has('tgl_perolehan')) has-error @endif'>
									...
									<input style="width:150px" type="date" name="tgl_perolehan" id="tgl_perolehan" class="form-control" value="@if(count($errors) > 0){{old('tgl_perolehan')}}@else{{$kd->tgl_perolehan}}@endif" required>
								</div>
