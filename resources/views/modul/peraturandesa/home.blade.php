			...
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12">
						...
						<div class='form-group @if($errors->has('nomor_ditetapkan')) has-error @endif'>
							<label class='control-label'>Nomor Ditetapkan</label> --}}
							{{-- <input type='text' placeholder='Nomor Ditetapkan' class='form-control limited' id='nomor_ditetapkan' name='nomor_ditetapkan' maxlength='100' value='@if(count($errors) > 0){{old('nomor_ditetapkan')}}@endif' --}}
