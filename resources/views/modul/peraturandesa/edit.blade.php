							...
							<div class="col-md-12">
								...
								<div class='form-group @if($errors->has('tanggal_kesepakatan')) has-error @endif'>
									<div class="input-group">
										<input name="tanggal_kesepakatan" type="text" data-date-format="dd-mm-yyyy" data-date-viewmode="years" class="form-control date-picker" value="@if(count($errors) > 0){{old('tanggal_kesepakatan')}}@else{{tgl_id($data->tanggal_kesepakatan)}}@endif" placeholder="Tanggal Kesepakatan" required>
