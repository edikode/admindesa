		...
		<div class="col-sm-12">				
			<div class="panel panel-default">
				<div class="panel-body">	
					<form action="{{ url('data-peraturan-desa/'. $pd->id) }}" method="post" enctype="multipart/form-data">				
						<div class="row">
							<div class="col-md-12">
							...
							<div class="col-md-12">
								<div class='form-group @if($errors->has('jenis')) has-error @endif'>
									...
									<input type='text' placeholder='Jenis' class='form-control limited' id='jenis' name='jenis' maxlength='100' value='@if(count($errors) > 0){{old('jenis')}}@else{{$pd->jenis}}@endif'
									required>
								...
								<div class='form-group @if($errors->has('nomor_ditetapkan')) has-error @endif'>
									...
									<input type='text' placeholder='Nomor Ditetapkan' class='form-control limited' id='nomor_ditetapkan' name='nomor_ditetapkan' maxlength='100' value='@if(count($errors) > 0){{old('nomor_ditetapkan')}}@else{{$pd->nomor_ditetapkan}}@endif'
									required>
								...
								<div class='form-group'>
									...
									<textarea class='form-control limited' id='tentang' cols='10' rows='4' name='tentang' style='height:75px; resize:none;' maxlength='160'>@if(count($errors) > 0){{old('tentang')}}@else{{$pd->tentang}}@endif</textarea>
								</div>
								<div class='form-group'>
									<label class='control-label'>Uraian Singkat</label>
									<textarea class='form-control limited' id='uraian' cols='10' rows='4' name='uraian' style='height:75px; resize:none;' maxlength='160'>@if(count($errors) > 0){{old('uraian')}}@else{{$pd->uraian}}@endif</textarea>
								</div>
								<div class='form-group @if($errors->has('tanggal_kesepakatan')) has-error @endif'>
									...
									{{-- <input type='text' placeholder='Tanggal Kesepakatan' class='form-control limited' id='tanggal_kesepakatan' name='tanggal_kesepakatan' maxlength='100' value='@if(count($errors) > 0){{old('tanggal_kesepakatan')}}@else{{$pd->tanggal_kesepakatan}}@endif' --}}
									<input style="width:150px" type="date" name="tanggal_kesepakatan" id="tanggal_kesepakatan" class="form-control" value="@if(count($errors) > 0){{old('tanggal_kesepakatan')}}@else{{$pd->tanggal_kesepakatan}}@endif" required>
								...
								<div class='form-group @if($errors->has('tanggal_dilaporkan')) has-error @endif'>
									...
									<input type='text' placeholder='Nomor dan Tanggal Dilaporkan' class='form-control limited' id='tanggal_dilaporkan' name='tanggal_dilaporkan' maxlength='100' value='@if(count($errors) > 0){{old('tanggal_dilaporkan')}}@else{{$pd->tanggal_dilaporkan}}@endif'
									required>
								...
								<div class='form-group @if($errors->has('tanggal_diundang')) has-error @endif'>
									...
									<input type='text' placeholder='Nomor dan Tanggal Diundang' class='form-control limited' id='tanggal_diundang' name='tanggal_diundang' maxlength='100' value='@if(count($errors) > 0){{old('tanggal_diundang')}}@else{{$pd->tanggal_diundang}}@endif'
									required>
								...
								<div class='form-group @if($errors->has('tanggal_berita_desa')) has-error @endif'>
									...
									<input type='text' placeholder='Nomor dan Tanggal Berita Desa' class='form-control limited' id='tanggal_berita_desa' name='tanggal_berita_desa' maxlength='100' value='@if(count($errors) > 0){{old('tanggal_berita_desa')}}@else{{$pd->tanggal_berita_desa}}@endif'
									required>
