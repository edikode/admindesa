...
class DataTanahKasDesa extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request, [
            'nomor_sertifikat'      => 'numeric|unique:tanah_kas_desa,nomor_sertifikat,'.$kd['id'],
        ]);
        ...
        $kd->tgl_perolehan = tgl_en($request->tgl_perolehan);
    ...
    public function destroy($id)
    {
        ...
        $kd->delete();
        Session::flash('pesan_sukses', 'Data Tanah Kas Desa Nomor Sertifikat "'. $kd->nomor_sertifikat .'" Berhasil Dihapus');
