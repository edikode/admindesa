	...
	<div class="main-navigation navbar-collapse collapse">
		...
		<ul class="main-navigation-menu">
			<li class="{{ set_active('home') }}">
				<a href="{{ url('home') }}"><i class="clip-home-2"></i>
			...
			<li class="{{ set_active([
				...
				<ul class="sub-menu">					
					...
					<li class="{{ set_active(['data-rekapitulasi-penduduk', Request::is('data-rekapitulasi-penduduk/*')]) }}">
						<a href="{{ url('data-rekapitulasi-penduduk') }}"><span class='title'>Data Rekapitulasi Jumlah Penduduk Akhir Bulan</span></a>
					</li>
			...
			<li class="{{ set_active(['setting', Request::is('setting/*')]) }}">
				<a href="{{ url('/setting') }}"><i class="clip-cog-2"></i>
