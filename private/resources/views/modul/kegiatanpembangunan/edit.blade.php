						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class='form-group @if($errors->has('nama')) has-error @endif'>
									...
									<input type='text' placeholder='Nama Proyek/Kegiatan' class='form-control limited' id='nama' name='nama' maxlength='45' value='@if(count($errors) > 0){{old('nama')}}@else{{$pd->nama}}@endif'
									required>
								...
								<div class='form-group @if($errors->has('waktu')) has-error @endif'>
									...
									<div class="input-group">
										<input name="waktu" type="text" data-date-format="dd-mm-yyyy" data-date-viewmode="years" class="form-control date-picker" value="@if(count($errors) > 0){{old('waktu')}}@else{{tgl_id($pd->waktu)}}@endif" placeholder="Waktu Proyek" required autocomplete="off">
								...
								<div class='form-group @if($errors->has('pelaksana')) has-error @endif'>
									...
									<input type='text' placeholder='Pelaksana' class='form-control limited' id='pelaksana' name='pelaksana' maxlength='45' value='@if(count($errors) > 0){{old('pelaksana')}}@else{{$pd->pelaksana}}@endif'
									required>
