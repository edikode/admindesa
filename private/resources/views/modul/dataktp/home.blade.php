					...
					<div class="col-md-12">
						<div class='form-group @if($errors->has('nama')) has-error @endif'>
							...
							<select name="nama" id="nama" class="form-control search-select">
								...
								@foreach ($datainduk as $d)
									@php if(CekData("ktp_kk","data_induk_id",$d->id)){ continue; } @endphp
						...
						<div class="row">
							<div class="col-md-8">
								<div class='form-group @if($errors->has('tmp_dikeluarkan')) has-error @endif'>
									...
									<input type='text' placeholder='Tempat Dikeluarkan' class='form-control limited' id='tmp_dikeluarkan' name='tmp_dikeluarkan' maxlength='45' value='@if(count($errors) > 0){{old('tmp_dikeluarkan')}}@endif' required>
							...
							<div class="col-md-4">
								<div class='form-group @if($errors->has('tgl_dikeluarkan')) has-error @endif'>
									...
									<div class="input-group">
										<input name="tgl_dikeluarkan" type="text" data-date-format="dd-mm-yyyy" data-date-viewmode="years" class="form-control date-picker" value="@if(count($errors) > 0){{old('tgl_dikeluarkan')}}@endif" required autocomplete="off" placeholder="Tanggal Dikeluarkan">
						...
						<div class='form-group @if($errors->has('status_dikeluarga')) has-error @endif'>
							...
							<select name="status_dikeluarga" id="status_dikeluarga" class="form-control" required>
								<option value="">--- Pilih ---</option>
								<option value="Ayah" @if(count($errors) > 0) @if(old('status_dikeluarga') == "Ayah") selected @endif @endif>Ayah</option>
								<option value="Ibu" @if(count($errors) > 0) @if(old('status_dikeluarga') == "Ibu") selected @endif @endif>Ibu</option>
								<option value="Anak" @if(count($errors) > 0) @if(old('status_dikeluarga') == "Anak") selected @endif @endif>Anak</option>
								<option value="Lainnya" @if(count($errors) > 0) @if(old('status_dikeluarga') == "Lainnya") selected @endif @endif>Lainnya</option>
							</select>
						...
						<div class='form-group @if($errors->has('ayah')) has-error @endif'>
							...
							<input type='text' placeholder='Nama Ayah' class='form-control limited' id='ayah' name='ayah' maxlength='45' value='@if(count($errors) > 0){{old('ayah')}}@endif'>
						...
						<div class='form-group @if($errors->has('ibu')) has-error @endif'>
							...
							<input type='text' placeholder='Nama Ibu' class='form-control limited' id='ibu' name='ibu' maxlength='45' value='@if(count($errors) > 0){{old('ibu')}}@endif'>
						...
						<div class='form-group @if($errors->has('tgl_didesa')) has-error @endif'>
							...
							<div class="input-group">
								<input name="tgl_didesa" type="text" data-date-format="dd-mm-yyyy" data-date-viewmode="years" class="form-control date-picker" value="@if(count($errors) > 0){{old('tgl_didesa')}}@endif" required autocomplete="off" placeholder="Tanggal Mulai Didesa">
								<span class="input-group-addon"> <i class="fa fa-calendar"></i> </span>
							</div>
