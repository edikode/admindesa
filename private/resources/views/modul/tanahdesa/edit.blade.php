						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class='form-group @if($errors->has('nama')) has-error @endif'>
									...
									<input type='text' placeholder='Nama Perorangan / Badan Hukum' class='form-control limited' id='nama' name='nama' maxlength='45' value='@if(count($errors) > 0){{old('nama')}}@else{{$kd->nama}}@endif'
									required>
								...
								<div class='form-group @if($errors->has('jumlah')) has-error @endif'>
									...
									<input type='number' placeholder='luas tanah dalam meter persegi' class='form-control limited' id='jumlah' name='jumlah' maxlength='10' value='@if(count($errors) > 0){{old('jumlah')}}@else{{$kd->jumlah}}@endif'
									required>
								...
								<div class='form-group @if($errors->has('luas')) has-error @endif'>
									...
									<input type='number' placeholder='Luas Hak Tanah' class='form-control limited' id='luas' name='luas' maxlength='10' value='@if(count($errors) > 0){{old('luas')}}@else{{$kd->luas}}@endif'
									required>
								...
								<div class='form-group @if($errors->has('luas_penggunaan')) has-error @endif'>
									...
									<input type='number' placeholder='Luas Penggunaan Tanah' class='form-control limited' id='luas_penggunaan' name='luas_penggunaan' maxlength='10' value='@if(count($errors) > 0){{old('luas_penggunaan')}}@else{{$kd->luas_penggunaan}}@endif'
									required>
