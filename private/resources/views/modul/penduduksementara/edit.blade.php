						...
						<div class="row">
							...
							<div class="col-md-12">
								...
								<div class='form-group @if($errors->has('nomor_identitas')) has-error @endif'>
									...
									<input type='text' placeholder='Nomor Identitas' class='form-control limited' id='nomor_identitas' name='nomor_identitas' maxlength='45' value='@if(count($errors) > 0){{old('nomor_identitas')}}@else{{$pd->nomor_identitas}}@endif'>
									...
									<div class="col-md-4">
										<div class='form-group @if($errors->has('tgl_lahir')) has-error @endif'>
											...
											<div class="input-group">
												<input name="tgl_lahir" type="text" data-date-format="dd-mm-yyyy" data-date-viewmode="years" class="form-control date-picker" value="@if(count($errors) > 0){{old('tgl_lahir')}}@else{{tgl_id($pd->tgl_lahir)}}@endif" placeholder="Tanggal Lahir" required autocomplete="off">
								...
								<div class='form-group @if($errors->has('datang_dari')) has-error @endif'>
									...
									<input type='text' placeholder='Datang Dari' class='form-control limited' id='datang_dari' name='datang_dari' maxlength='45' value='@if(count($errors) > 0){{old('pekerjaan')}}@else{{$pd->datang_dari}}@endif' required>
								...
								<div class='form-group @if($errors->has('nama_didatangi')) has-error @endif'>
									...
									<input type='text' placeholder='Nama yg Didatangi' class='form-control limited' id='nama_didatangi' name='nama_didatangi' maxlength='45' value='@if(count($errors) > 0){{old('nama_didatangi')}}@else{{$pd->nama_didatangi}}@endif' required>
								...
								<div class='form-group @if($errors->has('datang_tgl')) has-error @endif'>
									...
									<div class="input-group">
										<input name="datang_tgl" type="text" data-date-format="dd-mm-yyyy" data-date-viewmode="years" class="form-control date-picker" value="@if(count($errors) > 0){{old('datang_tgl')}}@else{{tgl_id($pd->datang_tgl)}}@endif" placeholder="Datang Tanggal" required autocomplete="off">
										<span class="input-group-addon"> <i class="fa fa-calendar"></i> </span>
									</div>
								...
								<div class='form-group @if($errors->has('pergi_tgl')) has-error @endif'>
									...
									<div class="input-group">
										<input name="pergi_tgl" type="text" data-date-format="dd-mm-yyyy" data-date-viewmode="years" class="form-control date-picker" value="@if(count($errors) > 0){{old('pergi_tgl')}}@else{{tgl_id($pd->pergi_tgl)}}@endif" placeholder="Pergi Tanggal" required autocomplete="off">
										<span class="input-group-addon"> <i class="fa fa-calendar"></i> </span>
									</div>
