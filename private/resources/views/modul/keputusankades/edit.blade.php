		...
		<div class="col-sm-12">				
			<div class="panel panel-default">
				<div class="panel-body">	
					<form action="{{ url('data-keputusan-kepala-desa/'. $data->id) }}" method="post" enctype="multipart/form-data">				
						<div class="row">
							<div class="col-md-12">
							...
							<div class="col-md-12">
								<div class='form-group @if($errors->has('nomor_keputusan')) has-error @endif'>
									...
									<input type='text' placeholder='Nomor Keputusan' class='form-control limited' id='nomor_keputusan' name='nomor_keputusan' maxlength='100' value='@if(count($errors) > 0){{old('nomor_keputusan')}}@else{{$data->nomor_keputusan}}@endif'
									required>
								...
								<div class='form-group @if($errors->has('nomor_dilaporkan')) has-error @endif'>
									...
									<input type='text' placeholder='Nomor dan Tanggal Dilaporkan' class='form-control limited' id='nomor_dilaporkan' name='nomor_dilaporkan' maxlength='100' value='@if(count($errors) > 0){{old('nomor_dilaporkan')}}@else{{$data->nomor_dilaporkan}}@endif'
									required>
