				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class='form-group @if($errors->has('umur')) has-error @endif'>
							...
							<input type='number' placeholder='Umur' class='form-control limited' id='umur' name='umur' maxlength='3' value='@if(count($errors) > 0){{old('umur')}}@endif'
							required>
						...
						<div class='form-group @if($errors->has('pendidikan')) has-error @endif'>
							...
							<input type='text' placeholder='Pendidikan/Kursus' class='form-control limited' id='pendidikan' name='pendidikan' maxlength='45' value='@if(count($errors) > 0){{old('pendidikan')}}@endif'
							required>
						...
						<div class='form-group @if($errors->has('bidang')) has-error @endif'>
							...
							<input type='text' placeholder='Bidang' class='form-control limited' id='bidang' name='bidang' maxlength='45' value='@if(count($errors) > 0){{old('bidang')}}@endif'
							required>
