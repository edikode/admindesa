						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class='form-group @if($errors->has('nama')) has-error @endif'>
									...
									<input type='text' placeholder='Nama' class='form-control limited' id='nama' name='nama' maxlength='45' value='@if(count($errors) > 0){{old('nama')}}@else{{$pd->nama}}@endif'
									required>
								...
								<div class="row">
									<div class="col-md-8">
										<div class='form-group @if($errors->has('tmp_lahir')) has-error @endif'>
											...
											<input type='text' placeholder='Tempat Lahir' class='form-control limited' id='tmp_lahir' name='tmp_lahir' maxlength='45' value='@if(count($errors) > 0){{old('tmp_lahir')}}@else{{$pd->tmp_lahir}}@endif' required>
									...
									<div class="col-md-4">
										<div class='form-group @if($errors->has('gol_darah')) has-error @endif'>
											...
											<select name="gol_darah" id="gol_darah" class="form-control" required>
												<option value="">--- Pilih ---</option>
												<option value="A" @if($pd->gol_darah == "A") selected @endif>A</option>
												<option value="B" @if($pd->gol_darah == "B") selected @endif>B</option>
												<option value="AB" @if($pd->gol_darah == "AB") selected @endif>AB</option>
												<option value="O" @if($pd->gol_darah == "O") selected @endif>O</option>
												<option value="Lainnya" @if($pd->gol_darah == "Lainnya") selected @endif>Lainnya</option>
											</select>
								...
								<div class='form-group @if($errors->has('pendidikan_terakhir')) has-error @endif'>
									...
									<input type='text' placeholder='Pendidikan Terakhir' class='form-control limited' id='pendidikan_terakhir' name='pendidikan_terakhir' maxlength='45' value='@if(count($errors) > 0){{old('pendidikan_terakhir')}}@else{{$pd->pendidikan_terakhir}}@endif' required>
								...
								<div class='form-group @if($errors->has('pekerjaan')) has-error @endif'>
									...
									<input type='text' placeholder='Pekerjaan' class='form-control limited' id='pekerjaan' name='pekerjaan' maxlength='45' value='@if(count($errors) > 0){{old('pekerjaan')}}@else{{$pd->pekerjaan}}@endif' required>
								...
								<div class="row">
									<div class="col-md-4">
										<div class='form-group @if($errors->has('rtrw')) has-error @endif'>
											...
											<input type='text' placeholder='RT/RW' class='form-control limited' id='rtrw' name='rtrw' maxlength='10' value='@if(count($errors) > 0){{old('rtrw')}}@else{{$pd->rtrw}}@endif'
											required>
									...
									<div class="col-md-4">
										<div class='form-group @if($errors->has('dusun')) has-error @endif'>
											...
											<input type='text' placeholder='Dusun' class='form-control limited' id='dusun' name='dusun' maxlength='45' value='@if(count($errors) > 0){{old('dusun')}}@else{{$pd->dusun}}@endif'
											required>
									...
									<div class="col-md-4">
										<div class='form-group @if($errors->has('desa')) has-error @endif'>
											...
											<input type='text' placeholder='Desa' class='form-control limited' id='desa' name='desa' maxlength='45' value='@if(count($errors) > 0){{old('desa')}}@else{{$pd->desa}}@endif'
											required>
									...
									<div class="col-md-4">
										<div class='form-group @if($errors->has('kecamatan')) has-error @endif'>
											...
											<input type='text' placeholder='Kecamatan' class='form-control limited' id='kecamatan' name='kecamatan' maxlength='45' value='@if(count($errors) > 0){{old('kecamatan')}}@else{{$pd->kecamatan}}@endif'
											required>
									...
									<div class="col-md-4">
										<div class='form-group @if($errors->has('kabupaten')) has-error @endif'>
											...
											<input type='text' placeholder='Kabupaten' class='form-control limited' id='kabupaten' name='kabupaten' maxlength='45' value='@if(count($errors) > 0){{old('kabupaten')}}@else{{$pd->kabupaten}}@endif'
											required>
									...
									<div class="col-md-4">
										<div class='form-group @if($errors->has('kodepos')) has-error @endif'>
											...
											<input type='text' placeholder='Kode Pos' class='form-control limited' id='kodepos' name='kodepos' maxlength='45' value='@if(count($errors) > 0){{old('kodepos')}}@else{{$pd->kodepos}}@endif'
											required>
								...
								<div class='form-group @if($errors->has('nik')) has-error @endif'>
									...
									<input type='text' placeholder='NIK' class='form-control limited' id='nik' name='nik' maxlength='16' value='@if(count($errors) > 0){{old('nik')}}@else{{$pd->nik}}@endif'>
								...
								<div class='form-group @if($errors->has('no_kk')) has-error @endif'>
									...
									<input type='text' placeholder='No KK' class='form-control limited' id='no_kk' name='no_kk' maxlength='45' value='@if(count($errors) > 0){{old('no_kk')}}@else{{$pd->no_kk}}@endif'>
