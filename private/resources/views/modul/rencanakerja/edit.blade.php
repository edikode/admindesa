						...
						<div class="row">
							...
							<div class="col-md-12">
								...
								<div class='form-group @if($errors->has('lokasi')) has-error @endif'>
									...
									<input type='text' placeholder='Lokasi' class='form-control limited' id='lokasi' name='lokasi' maxlength='160' value='@if(count($errors) > 0){{old('lokasi')}}@else{{$pd->lokasi}}@endif'
									required>
