						...
						<div class="row">
							...
							<div class="col-md-12">
								...
								<div class='form-group @if($errors->has('niap')) has-error @endif'>
									...
									<input type='text' placeholder='NIAP' class='form-control limited' id='niap' name='niap' maxlength='45' value='@if(count($errors) > 0){{old('niap')}}@else{{$pd->niap}}@endif'>
								...
								<div class='form-group @if($errors->has('nip')) has-error @endif'>
									...
									<input type='text' placeholder='NIP' class='form-control limited' id='nip' name='nip' maxlength='18' value='@if(count($errors) > 0){{old('nip')}}@else{{$pd->nip}}@endif'>
								...
								<div class='form-group @if($errors->has('ttl')) has-error @endif'>
									...
									<input type='text' placeholder='Tempat, Tanggal Lahir' class='form-control limited' id='ttl' name='ttl' maxlength='50' value='@if(count($errors) > 0){{old('ttl')}}@else{{$pd->ttl}}@endif' required>
								...
								<div class='form-group @if($errors->has('pangkat')) has-error @endif'>
									...
									<input type='text' placeholder='Pangkat' class='form-control limited' id='pangkat' name='pangkat' maxlength='50' value='@if(count($errors) > 0){{old('pangkat')}}@else{{$pd->pangkat}}@endif' required>
								...
								<div class='form-group @if($errors->has('jabatan')) has-error @endif'>
									...
									<input type='text' placeholder='Jabatan' class='form-control limited' id='jabatan' name='jabatan' maxlength='50' value='@if(count($errors) > 0){{old('jabatan')}}@else{{$pd->jabatan}}@endif' required>
								...
								<div class='form-group @if($errors->has('pendidikan_terakhir')) has-error @endif'>
									...
									<input type='text' placeholder='Pendidikan Terakhir' class='form-control limited' id='pendidikan_terakhir' name='pendidikan_terakhir' maxlength='50' value='@if(count($errors) > 0){{old('pendidikan_terakhir')}}@else{{$pd->pendidikan_terakhir}}@endif' required>
								...
								<div class='form-group @if($errors->has('nomor_pengangkatan')) has-error @endif'>
									...
									<input type='text' placeholder='Nomor Pengangkatan' class='form-control limited' id='nomor_pengangkatan' name='nomor_pengangkatan' maxlength='45' value='@if(count($errors) > 0){{old('nomor_pengangkatan')}}@else{{$pd->nomor_pengangkatan}}@endif'
									required>
								...
								<div class='form-group @if($errors->has('nomor_pemberhentian')) has-error @endif'>
									...
									<input type='text' placeholder='Nomor Pemberhentian' class='form-control limited' id='nomor_pemberhentian' name='nomor_pemberhentian' maxlength='45' value='@if(count($errors) > 0){{old('nomor_pemberhentian')}}@else{{$pd->nomor_pemberhentian}}@endif'>
