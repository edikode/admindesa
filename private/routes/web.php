...
Route::post('data-rekapitulasi-penduduk/cari', 'Modul\DataRekapPenduduk@pencarian');
...
Route::get('setting', 'Modul\Setting@index');
Route::get('setting/pengguna', 'Modul\Setting@pengguna');
Route::post('setting/pengguna', 'Modul\Setting@simpanpengguna');
Route::get('setting/hapusfotoadmin', 'Modul\Setting@hapusfotoadmin');
Route::get('setting/info-desa', 'Modul\Setting@infodesa');
Route::post('setting/info-desa', 'Modul\Setting@simpaninfodesa');
Route::get('setting/hapuslogodesa', 'Modul\Setting@hapuslogodesa');

Route::get('setting/ganti-password', 'Modul\Setting@gantipassword');
Route::post('setting/ganti-password', 'Modul\Setting@simpanpassword');
